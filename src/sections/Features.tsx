      ...
      <div className="container">
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature) => (
            ...
            >
              <span className="rounded-full size-5 text-xl inline-flex items-center justify-center bg-lime-400 text-neutral-950 group-hover:rotate-45 transition duration-500">
                &#10038;
              </span>
